 ...
 * @author  __USER__
 */
public class ReceiptAlter extends javax.swing.JFrame {
	private static int rnumber = 0;
	private static float rprice = 0;
	private static float sum = 0;
	/** Creates new form ReceiptAlter */
	public ReceiptAlter() {
		initComponents();
		setLocation(250,200);
	}
...
//		setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
		...
		layout.setHorizontalGroup(layout
				...
				.addGroup(
						layout.createSequentialGroup().addGap(178, 178, 178)
	...
	private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {
		...
		try {
			//4、执行
			String sql1 = "select * from receipt where Rid ='" + rid_temp
					+ "';";
			ResultSet rs = st.executeQuery(sql1);
			//5、处理执行结果
			while (rs.next()) {
				String gname_tmp = rs.getString(2);
				jTextField15.setText(gname_tmp);
				int rnumber_tmp = rs.getInt(3);
				jTextField12.setText(Integer.toString(rnumber_tmp));
				float rprice_tmp = rs.getFloat(4);
				jTextField18.setText(Float.toString(rprice_tmp));
				float sum_tmp = rs.getFloat(5);
				jTextField16.setText(Float.toString(sum_tmp));
				String sname_tmp = rs.getString(6);
				jTextField17.setText(sname_tmp);
				String rdate_tmp = rs.getString(7);
				jTextField13.setText(rdate_tmp);
			}
	...
	private void jTextField16ActionPerformed(java.awt.event.ActionEvent evt) {
		rnumber = Integer.parseInt(this.jTextField12.getText());
		rprice = Float.valueOf(this.jTextField18.getText());
		sum = rnumber * rprice;
		jTextField16.setText(Float.toString(sum));	}
	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
		...
		String gname = jTextField15.getText();
		int rnumber = Integer.parseInt(jTextField12.getText());
		float rprice = Float.parseFloat(jTextField18.getText());
		float sum = Float.parseFloat(jTextField16.getText());
		String sname = jTextField17.getText();
		String rdate = jTextField13.getText();
		String sql2 = "update receipt set Gname = '" + gname + "',"
				+ " Rnumber = '" + rnumber + "',Rprice = '" + rprice
				+ "',sum = '" + sum + "'," + "Sname = '" + sname + "',"
				+ "Rdate = '" + rdate + "'where Rid = '" + rid + "';";
		try {
